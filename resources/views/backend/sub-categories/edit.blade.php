...
<div class="row">
    <div class="col-md-12 col-sm-12  animation">
        <div class="x_panel">
          <div class="x_title">
            <h2>Edit Sub Categories<small>Edit a product sub category</small></h2>
          ...
          <div class="x_content">
            <form id="demo-form" action="{{route('product-sub-category.update',$subCategory->id)}}" method="Post">
              @csrf
              @method('PUT')
              <div class="row">
