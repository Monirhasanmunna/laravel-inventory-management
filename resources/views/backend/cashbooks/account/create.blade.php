            ...
            <form id="demo-form" action="{{route('accounts.store')}}" method="Post">
              ...
              <div class="row">
                ...
                <div class="col-6 mb-3">
                  ...
                  <input type="text" id="branch" class="form-control" name="branch_name" class="@error('branch_name') is-invalid @enderror">
                  @error('branch_name')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="col-6 mb-3">
                  ...
                  <input type="number" id="account_number" class="form-control" name="account_number" class="@error('account_number') is-invalid @enderror">
