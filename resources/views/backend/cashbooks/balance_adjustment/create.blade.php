...
<div class="row">
    <div class="col-md-12 col-sm-12  animation">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form id="demo-form" action="{{route('balance.store')}}" method="Post">
              @csrf
              <div class="row">
                ...
                <div class="col-6 mb-3">
                  ...
                  <select id="heard" class="form-control @error('status') is-invalid @enderror" name="type">
                    ...
                    <option value="removeBalance">Remove Balance</option>
                  </select>
                </div>

                <div class="col-6 mb-3">
                  <label for="availabe-balace">Availabe Balance * :</label>
                  <input type="number" readonly id="availabe-balace" name="available_balance" class="form-control">
                </div>
