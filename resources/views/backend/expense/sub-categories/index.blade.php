...
<div class="row">
    <div class="col-md-12 col-sm-12 animation">
        <div class="x_panel">
          <div class="x_title">
            <h2>Expense Sub Categories List <small>All expense sub category list show here</small></h2>

            <div class="text-right">
                <a href="{{route('expense.sub_categories.create')}}" class="btn btn-success"><i class="fa-solid fa-square-plus mr-2" style="font-size: 18px"></i>Add New</a>
            </div>
            <div class="clearfix"></div>
          </div>
                    ...
                    @foreach ($subCategories as $subCategory)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{route('expense.sub_categories.edit',$subCategory->id)}}" class="btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="javascript:void(0)" onclick="deleteItem({{$subCategory->id}})" class="btn-sm btn-danger"><i class="fa-solid fa-trash"></i></a>
                            </td>

                            <form action="{{route('expense.sub_categories.destroy',$subCategory->id)}}" method="POST" class="d-none deleteForm-{{$subCategory->id}}">
                              @method('PUT')
                              @csrf
                            </form>
                        </tr>
