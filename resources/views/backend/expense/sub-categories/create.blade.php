...
<div class="row">
    <div class="col-md-12 col-sm-12  animation">
        <div class="x_panel">
          <div class="x_title">
            <h2>Add Expense Sub Categories<small>add expense a product sub category</small></h2>
          ...
          <div class="x_content">
            <form id="demo-form" action="{{route('expense.sub_categories.store')}}" method="Post">
              @csrf
              <div class="row">
