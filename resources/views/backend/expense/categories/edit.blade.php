...
<div class="row">
    <div class="col-md-12 col-sm-12  animation">
        <div class="x_panel">
          <div class="x_title">
            <h2>Edit Expense Category<small>Edit a expense product category</small></h2>
          ...
          <div class="x_content">
            <form id="demo-form" action="{{route('expense.categories.update',$category->id)}}" method="Post">
              @method('PUT')
              @csrf
              <div class="row">
                <div class="col-6">
