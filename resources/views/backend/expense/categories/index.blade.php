        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <div class="text-right">
                <a href="{{route('expense.categories.create')}}" class="btn btn-success"><i class="fa-solid fa-square-plus mr-2" style="font-size: 18px"></i>Add New</a>
            </div>
                    ...
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{route('expense.categories.edit',$category->id)}}" class="btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="javascript:void(0)" onclick="deleteItem({{$category->id}})" class="btn-sm btn-danger"><i class="fa-solid fa-trash"></i></a>
                            </td>

                            <form action="{{route('expense.categories.destroy',$category->id)}}" method="POST" class="d-none deleteForm-{{$category->id}}">
                              @method('PUT')
                              @csrf
                            </form>
                        </tr>
