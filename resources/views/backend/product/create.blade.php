...
<div class="row">
    <div class="col-md-12 col-sm-12  animation">
        <div class="x_panel">
          <div class="x_title">
            <h2>Add Product<small>add a product</small></h2>
          ...
          <div class="x_content">
            <form id="demo-form" action="{{route('product.store')}}" method="Post" enctype="multipart/form-data">
              @csrf
              <div class="row">
                <div class="col-4">
                ...
                <div class="col-4">
                  ...
                  <input type="text" id="model" class="form-control" name="model" class="@error('model') is-invalid @enderror">
                  @error('model')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="col-4 mt-3">
                  ...
                  <select id="sub_category" class="form-control @error('sub_category_id') is-invalid @enderror js-example-basic-single" disabled name="sub_category_id">
                    <option >Please category select first</option>
                  </select>
                </div>
                ...
                <div class="col-4 mt-3">
                  ...
                  <input type="number" id="regular_price" class="form-control" name="regular_price" class="@error('regular price') is-invalid @enderror">
                  @error('regular price')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="col-4 mt-3">
                  ...
                  <input type="number" id="discount" class="form-control" name="discount" class="@error('discount') is-invalid @enderror">
                  @error('discount')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="col-4 mt-3">
                  ...
                  <input type="number" id="selling_price" readonly class="form-control" name="selling_price" class="@error('selling_price') is-invalid @enderror">
                  @error('selling_price')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="col-4 mt-3">
                  ...
                  <input type="number" id="alert_quantity" class="form-control" name="alert_quantity" class="@error('alert_quantity') is-invalid @enderror">
